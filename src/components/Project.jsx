...
const Project = ({
  ...
  return (
    <div className="w-full min-h-96 shadow-xl shadow-gray-300 rounded-lg bg-white p-8 text-primary mb-8">
      <h5 className="text-2xl font-semibold mb-8 text-tertiary">{title}</h5>
      ...
      <div className="text-[0.9rem]">
        {livePreviewURL && (
          <a
            href={livePreviewURL}
            target="_blank"
            className="ring ring-gray-100 shadow-lg text-accent font-semibold py-2 px-4 rounded-md hover:-translate-y-0.5 hover:opacity-70 transition"
          >
            Live Preview
          </a>
        )}
